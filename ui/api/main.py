...
def list_providers() -> list[ProviderStatusResponse]:
    ...
    statuses = supported_provider_statuses(_registry)
    return [
        ProviderStatusResponse(
            provider=s.provider,
            available=s.available,
            missing_env_vars=s.missing_env_vars,
            missing_executables=s.missing_executables,
...
def get_provider_models(provider: str) -> ProviderModelsResponse:
...
def sync_provider_models(provider: str) -> SyncResultResponse:
