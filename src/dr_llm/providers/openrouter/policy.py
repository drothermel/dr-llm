...
OPENROUTER_MODEL_POLICIES: dict[str, OpenRouterModelPolicy] = {
    ...
    "google/gemma-3n-e4b-it": OpenRouterModelPolicy(
    ...
    "google/gemma-2-9b-it": OpenRouterModelPolicy(
    ...
    "google/gemma-3-4b-it": OpenRouterModelPolicy(
    ...
    "google/gemma-3-12b-it": OpenRouterModelPolicy(
    ...
    "google/gemma-3-27b-it": OpenRouterModelPolicy(
    ...
    "google/gemma-4-26b-a4b-it": OpenRouterModelPolicy(
    ...
    "google/gemma-4-31b-it": OpenRouterModelPolicy(
    ...
    "nvidia/nemotron-nano-12b-v2-vl": OpenRouterModelPolicy(
