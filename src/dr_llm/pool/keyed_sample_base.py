...
class KeyedSampleBase(BaseModel):
    ...
    def _base_insert_row(
        self,
        *,
        payload_column: SampleColumn | PendingColumn,
        metadata_column: SampleColumn | PendingColumn,
        source_run_id_column: SampleColumn | PendingColumn,
    ) -> dict[str, Any]:
        ...
        """
        return {
            payload_column: to_jsonable_python(self.payload),
            metadata_column: to_jsonable_python(self.metadata),
            source_run_id_column: self.source_run_id,
            **self.key_values,
        }
