...
from dr_llm.providers.kimi_code import (
    KIMI_CODE_BASE_URL,
...
def test_kimi_code_serializes_effort_and_adaptive_thinking() -> None:
    ...
    adapter = KimiCodeAdapter(client=client)
...
def test_kimi_code_serializes_budget_and_disabled_thinking() -> None:
    ...
    budget_adapter = KimiCodeAdapter(client=budget_client)
    ...
    off_adapter = KimiCodeAdapter(client=off_client)
